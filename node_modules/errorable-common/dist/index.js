...
var entities = ['administrator', 'admin', 'application', 'app', 'business', 'category', 'database', 'email', 'employee', 'file', 'favorite', 'id', 'merchant', 'merchandise', 'mobile', 'name', 'network', 'order', 'password', 'phone', 'price', 'signature', 'state', 'user'];

var actions = ['input', 'update'];
